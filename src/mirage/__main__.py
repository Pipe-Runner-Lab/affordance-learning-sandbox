...
from omniisaacgymenvs.utils.rlgames.rlgames_utils import (
    RLGPUAlgoObserver,
    RLGPUEnv,
)
...
class RLGTrainer:
    ...
    def launch_rlg_hydra(self, env):
        # `create_rlgpu_env` is environment construction function which is
        # passed to RL Games and called internally.
        ...
        env_configurations.register(
            "rlgpu",
            {"vecenv_type": "RLGPU", "env_creator": lambda **kwargs: env},
        )
    ...
    def run(self):
        ...
        experiment_dir = os.path.join(
            "runs", self.cfg.train.params.config.name
        )
