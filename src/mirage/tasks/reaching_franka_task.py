...
from omniisaacgymenvs.robots.articulations.franka import (  # noqa: E402
    Franka as Robot,
)
...
from omni.isaac.core.objects import DynamicSphere  # noqa: E402
from omni.isaac.core.utils.prims import get_prim_at_path  # noqa: E402
...
class ReachingFrankaTask(RLTask):
    ...
    def set_up_scene(self, scene) -> None:
        ...
        self._end_effectors = RigidPrimView(
            prim_paths_expr=f"/World/envs/.*/robot/{self._end_effector_link}",
    ...
    def init_data(self) -> None:
        self.robot_default_dof_pos = torch.tensor(
            np.radians([0, -45, 0, -135, 0, 90, 45, 0, 0]),
            device=self._device,
            dtype=torch.float32,
        )
    ...
    def get_observations(self) -> dict:
        ...
        (
            end_effector_pos,
            end_effector_rot,
        ) = self._end_effectors.get_world_poses(clone=False)
        ...
        self._computed_distance = torch.norm(
            end_effector_pos - target_pos, dim=-1
        )
    ...
    def reset_idx(self, env_ids) -> None:
        ...
        self._targets.set_world_poses(
            pos + self._env_pos[env_ids], indices=indices
        )
