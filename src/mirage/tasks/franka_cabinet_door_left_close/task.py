...
from .reward import LEFT_DOOR_ALMOST_CLOSED, LEFT_DOOR_JOINT_ALMOST_OPEN
...
class CustomTask(BaseTask):
    ...
    def get_observations(self) -> dict:
        ...
        self.obs_buf = torch.cat(
            (
                ...
                to_target,  # size 3
                cabinet_dof_pos[:, 0].unsqueeze(
                    -1
                ),  # top door joint pos - size 1
                cabinet_dof_vel[:, 0].unsqueeze(
                    -1
    ...
    def is_done(self) -> None:
        ...
        self.reset_buf = torch.where(
            self.cabinet_dof_pos[:, 0] > LEFT_DOOR_ALMOST_CLOSED,
