...
class CustomTask(BaseTask):
    ...
    def get_observations(self) -> dict:
        ...
        door_pos, door_rot = self._cabinets._right_door.get_world_poses(
            clone=False
        )
    ...
    def calculate_metrics(self) -> None:
        self.rew_buf[:] = compute_open_door_right_reward(
            self.actions,
            self.robot_dof_pos,
