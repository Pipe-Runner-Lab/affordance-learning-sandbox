...
from ..tasks.affordance_block_pick_place_task import (  # noqa: E402
    AffordanceBlockPickPlaceTask,
    TASK_CFG,
)
...
task = AffordanceBlockPickPlaceTask(
...
# load checkpoints
agent.load("runs/23-10-13_21-06-43-192896_PPO\checkpoints/best_agent.pt")
